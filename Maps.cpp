...
int main()
{
	...
	map<char,int>::iterator i;
 	while(1)
 	{
 		...
 		switch(ch)
 		{
 			case 1: cout<<"Inserting Element"<<endl;
 					...
 					m[key]=value;
 					break;
 			case 2: cout<<"Delete element"<<endl;
 			...
 			case 4: cout<<"Value"<<endl;
 					...
 					break;
 			case 5: cout<<"Size of map"<<endl;
 					cout<<"Size: "<<m.size();
 					break;
 			case 6: cout<<"Displaying Map"<<endl;
 					cout<<"Map is"<<endl;
 					for(i=m.begin();i!=m.end();i++)
 						cout<<"KEY: "<<i->first<<" VALUE: "<<i->second<<endl;
 					break;
 			case 7: cout<<"Operation Complete"<<endl;
 					exit(0);
 		}
 	}
}
